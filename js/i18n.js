...
window.HBC_I18N = (function() {
 ...
 const EN = {
  ...
  'találat': 'hits',
  'Írj be legalább 2 betűt a fenti keresőbe (pl. „kenyér", „alma", „rizs"), és a beépített táblázat találatai itt jelennek meg.': 'Type at least 2 letters into the search box above (e.g. "bread", "apple", "rice") and matches from the built-in table appear here.',
