...
window.HBC_I18N = (function () {
  ...
  const EN = {
    ...
    'Lakcím': 'Home address', 'Értesítendő hozzátartozók': 'Contacts to notify',
    'Név': 'Name', 'Kapcsolat (pl. párom)': 'Relation (e.g. partner)', 'Telefonszám': 'Phone number',
    ...
    'Szinkron kész!': 'Sync complete!', 'Szinkronhiba': 'Sync error', 'Ismeretlen hiba.': 'Unknown error.',
    'Ételek a bejegyzésben': 'Foods in this entry', 'Étel hozzáadása': 'Add food',
    '🍽️ Egyéb/Extra CH (g)': '🍽️ Other/extra carbs (g)', 'TELJES CH': 'TOTAL carbs', 'Keresés...': 'Search...',
